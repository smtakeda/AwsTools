...
use lib qw(../../../.);  
 ...
 # @TODO: set request. Action can be passed as Amazon::EC2::Model::ReleaseAddressRequest
 ...
 # invokeReleaseAddress($service, $request);
    ...
    #
  sub invokeReleaseAddress {
      my ($service, $request) = @_;  
      eval {
              my $response = $service->releaseAddress($request);
              
                print ("Service Response\n");
                print ("=============================================================================\n");

                print("        ReleaseAddressResponse\n");
