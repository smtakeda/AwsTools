...
use lib qw(../../../.);  
 ...
 # sample for Deactivate License Action
 #**********************************************************************/
 use Amazon::EC2::Model::DeactivateLicenseRequest;
 # @TODO: set request. Action can be passed as Amazon::EC2::Model::DeactivateLicenseRequest
 # object or hash of parameters
 # invokeDeactivateLicense($service, $request);

                                                                                
    # 
    # Deactivate License Action Sample
    #
  sub invokeDeactivateLicense {
      my ($service, $request) = @_;  
      eval {
              my $response = $service->deactivateLicense($request);
              
                print ("Service Response\n");
                print ("=============================================================================\n");

                print("        DeactivateLicenseResponse\n");
