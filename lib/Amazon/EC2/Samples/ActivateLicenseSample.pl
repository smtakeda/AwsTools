...
use lib qw(../../../.);  
 ...
 # sample for Activate License Action
 #**********************************************************************/
 use Amazon::EC2::Model::ActivateLicenseRequest;
 # @TODO: set request. Action can be passed as Amazon::EC2::Model::ActivateLicenseRequest
 # object or hash of parameters
 # invokeActivateLicense($service, $request);

                        
    # 
    # Activate License Action Sample
    #
  sub invokeActivateLicense {
      my ($service, $request) = @_;  
      eval {
              my $response = $service->activateLicense($request);
              
                print ("Service Response\n");
                print ("=============================================================================\n");

                print("        ActivateLicenseResponse\n");
