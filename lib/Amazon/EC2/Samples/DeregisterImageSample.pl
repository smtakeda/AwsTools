...
use lib qw(../../../.);  
 ...
 # @TODO: set request. Action can be passed as Amazon::EC2::Model::DeregisterImageRequest
 ...
 # invokeDeregisterImage($service, $request);
    ...
    #
  sub invokeDeregisterImage {
      my ($service, $request) = @_;  
      eval {
              my $response = $service->deregisterImage($request);
              
                print ("Service Response\n");
                print ("=============================================================================\n");

                print("        DeregisterImageResponse\n");
