...
use lib qw(../../../.);  
 ...
 #**********************************************************************/
 use Amazon::EC2::Model::DeleteVpnConnectionRequest;
 # @TODO: set request. Action can be passed as Amazon::EC2::Model::DeleteVpnConnectionRequest
 ...
 # invokeDeleteVpnConnection($service, $request);
    ...
    #
  sub invokeDeleteVpnConnection {
      my ($service, $request) = @_;  
      eval {
              my $response = $service->deleteVpnConnection($request);
              
                print ("Service Response\n");
                print ("=============================================================================\n");

                print("        DeleteVpnConnectionResponse\n");
