...
#
# Modify Instance Attribute  Sample
#
...
use lib qw(../../../.);  
 ...
 # sample for Modify Instance Attribute Action
 #**********************************************************************/
 use Amazon::EC2::Model::ModifyInstanceAttributeRequest;
 # @TODO: set request. Action can be passed as Amazon::EC2::Model::ModifyInstanceAttributeRequest
 # object or hash of parameters
 # invokeModifyInstanceAttribute($service, $request);

                                                                                                                                                                                                                                            
    # 
    # Modify Instance Attribute Action Sample
    #
  sub invokeModifyInstanceAttribute {
      my ($service, $request) = @_;  
      eval {
              my $response = $service->modifyInstanceAttribute($request);
              
                print ("Service Response\n");
                print ("=============================================================================\n");

                print("        ModifyInstanceAttributeResponse\n");
