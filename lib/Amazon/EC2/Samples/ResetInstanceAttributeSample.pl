...
#
# Reset Instance Attribute  Sample
#
...
use lib qw(../../../.);  
 ...
 # sample for Reset Instance Attribute Action
 #**********************************************************************/
 use Amazon::EC2::Model::ResetInstanceAttributeRequest;
 # @TODO: set request. Action can be passed as Amazon::EC2::Model::ResetInstanceAttributeRequest
 # object or hash of parameters
 # invokeResetInstanceAttribute($service, $request);

                                                                                                                                                                                                                                                
    # 
    # Reset Instance Attribute Action Sample
    #
  sub invokeResetInstanceAttribute {
      my ($service, $request) = @_;  
      eval {
              my $response = $service->resetInstanceAttribute($request);
              
                print ("Service Response\n");
                print ("=============================================================================\n");

                print("        ResetInstanceAttributeResponse\n");
