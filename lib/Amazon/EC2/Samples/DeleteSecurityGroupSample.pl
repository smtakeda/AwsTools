...
use lib qw(../../../.);  
 ...
 #**********************************************************************/
 use Amazon::EC2::Model::DeleteSecurityGroupRequest;
 # @TODO: set request. Action can be passed as Amazon::EC2::Model::DeleteSecurityGroupRequest
 ...
 # invokeDeleteSecurityGroup($service, $request);
    ...
    #
  sub invokeDeleteSecurityGroup {
      my ($service, $request) = @_;  
      eval {
              my $response = $service->deleteSecurityGroup($request);
              
                print ("Service Response\n");
                print ("=============================================================================\n");

                print("        DeleteSecurityGroupResponse\n");
