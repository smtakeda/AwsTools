...
use lib qw(../../../.);  
 ...
 #**********************************************************************/
 use Amazon::EC2::Model::DeleteVpnGatewayRequest;
 # @TODO: set request. Action can be passed as Amazon::EC2::Model::DeleteVpnGatewayRequest
 ...
 # invokeDeleteVpnGateway($service, $request);
    ...
    #
  sub invokeDeleteVpnGateway {
      my ($service, $request) = @_;  
      eval {
              my $response = $service->deleteVpnGateway($request);
              
                print ("Service Response\n");
                print ("=============================================================================\n");

                print("        DeleteVpnGatewayResponse\n");
