...
use lib qw(../../../.);  
 ...
 #**********************************************************************/
 use Amazon::EC2::Model::CreateDhcpOptionsRequest;
 # @TODO: set request. Action can be passed as Amazon::EC2::Model::CreateDhcpOptionsRequest
 ...
 # invokeCreateDhcpOptions($service, $request);
    ...
    #
  sub invokeCreateDhcpOptions {
      my ($service, $request) = @_;  
      eval {
              my $response = $service->createDhcpOptions($request);
              
                print ("Service Response\n");
                print ("=============================================================================\n");

                print("        CreateDhcpOptionsResponse\n");
                ...
                if ($response->isSetCreateDhcpOptionsResult()) { 
                    print("            CreateDhcpOptionsResult\n");
                    my $createDhcpOptionsResult = $response->getCreateDhcpOptionsResult();
                    if ($createDhcpOptionsResult->isSetDhcpOptions()) { 
                        print("                DhcpOptions\n");
                        my $dhcpOptions = $createDhcpOptionsResult->getDhcpOptions();
