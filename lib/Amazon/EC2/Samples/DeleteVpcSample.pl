...
use lib qw(../../../.);  
 ...
 # sample for Delete Vpc Action
 #**********************************************************************/
 use Amazon::EC2::Model::DeleteVpcRequest;
 # @TODO: set request. Action can be passed as Amazon::EC2::Model::DeleteVpcRequest
 # object or hash of parameters
 # invokeDeleteVpc($service, $request);

                                                                                                                                                                                                                                                                                                                
    # 
    # Delete Vpc Action Sample
    #
  sub invokeDeleteVpc {
      my ($service, $request) = @_;  
      eval {
              my $response = $service->deleteVpc($request);
              
                print ("Service Response\n");
                print ("=============================================================================\n");

                print("        DeleteVpcResponse\n");
