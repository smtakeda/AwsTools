...
use lib qw(../../../.);  
 ...
 #**********************************************************************/
 use Amazon::EC2::Model::CancelBundleTaskRequest;
 # @TODO: set request. Action can be passed as Amazon::EC2::Model::CancelBundleTaskRequest
 ...
 # invokeCancelBundleTask($service, $request);
    ...
    #
  sub invokeCancelBundleTask {
      my ($service, $request) = @_;  
      eval {
              my $response = $service->cancelBundleTask($request);
              
                print ("Service Response\n");
                print ("=============================================================================\n");

                print("        CancelBundleTaskResponse\n");
                ...
                if ($response->isSetCancelBundleTaskResult()) { 
                    print("            CancelBundleTaskResult\n");
                    my $cancelBundleTaskResult = $response->getCancelBundleTaskResult();
                    if ($cancelBundleTaskResult->isSetBundleTask()) { 
                        print("                BundleTask\n");
                        my $bundleTask = $cancelBundleTaskResult->getBundleTask();
