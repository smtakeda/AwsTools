...
use lib qw(../../../.);  
 ...
 #**********************************************************************/
 use Amazon::EC2::Model::ModifyImageAttributeRequest;
 # @TODO: set request. Action can be passed as Amazon::EC2::Model::ModifyImageAttributeRequest
 ...
 # invokeModifyImageAttribute($service, $request);
    ...
    #
  sub invokeModifyImageAttribute {
      my ($service, $request) = @_;  
      eval {
              my $response = $service->modifyImageAttribute($request);
              
                print ("Service Response\n");
                print ("=============================================================================\n");

                print("        ModifyImageAttributeResponse\n");
