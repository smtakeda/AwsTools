...
use lib qw(../../../.);  
 ...
 #**********************************************************************/
 use Amazon::EC2::Model::DetachVpnGatewayRequest;
 # @TODO: set request. Action can be passed as Amazon::EC2::Model::DetachVpnGatewayRequest
 ...
 # invokeDetachVpnGateway($service, $request);
    ...
    #
  sub invokeDetachVpnGateway {
      my ($service, $request) = @_;  
      eval {
              my $response = $service->detachVpnGateway($request);
              
                print ("Service Response\n");
                print ("=============================================================================\n");

                print("        DetachVpnGatewayResponse\n");
