...
use lib qw(../../../.);  
 ...
 #**********************************************************************/
 use Amazon::EC2::Model::CancelSpotInstanceRequestsRequest;
 # @TODO: set request. Action can be passed as Amazon::EC2::Model::CancelSpotInstanceRequestsRequest
 ...
 # invokeCancelSpotInstanceRequests($service, $request);
    ...
    #
  sub invokeCancelSpotInstanceRequests {
      my ($service, $request) = @_;  
      eval {
              my $response = $service->cancelSpotInstanceRequests($request);
              
                print ("Service Response\n");
                print ("=============================================================================\n");

                print("        CancelSpotInstanceRequestsResponse\n");
                ...
                if ($response->isSetCancelSpotInstanceRequestsResult()) { 
                    print("            CancelSpotInstanceRequestsResult\n");
                    my $cancelSpotInstanceRequestsResult = $response->getCancelSpotInstanceRequestsResult();
                    my $cancelledSpotInstanceRequestList = $cancelSpotInstanceRequestsResult->getCancelledSpotInstanceRequest();
                    foreach (@$cancelledSpotInstanceRequestList) {
                        my $cancelledSpotInstanceRequest = $_;
                        print("                CancelledSpotInstanceRequest\n");
                        if ($cancelledSpotInstanceRequest->isSetSpotInstanceRequestId()) 
                        {
                            print("                    SpotInstanceRequestId\n");
                            print("                        " . $cancelledSpotInstanceRequest->getSpotInstanceRequestId() . "\n");
                        }
                        if ($cancelledSpotInstanceRequest->isSetState()) 
                        {
                            print("                    State\n");
                            print("                        " . $cancelledSpotInstanceRequest->getState() . "\n");
                        }
                    }
                } 
