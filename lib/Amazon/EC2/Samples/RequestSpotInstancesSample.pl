...
use lib qw(../../../.);  
 ...
 #**********************************************************************/
 use Amazon::EC2::Model::RequestSpotInstancesRequest;
 # @TODO: set request. Action can be passed as Amazon::EC2::Model::RequestSpotInstancesRequest
 ...
 # invokeRequestSpotInstances($service, $request);
    ...
    #
  sub invokeRequestSpotInstances {
      my ($service, $request) = @_;  
      eval {
              my $response = $service->requestSpotInstances($request);
              
                print ("Service Response\n");
                print ("=============================================================================\n");

                print("        RequestSpotInstancesResponse\n");
                ...
                if ($response->isSetRequestSpotInstancesResult()) { 
                    print("            RequestSpotInstancesResult\n");
                    my $requestSpotInstancesResult = $response->getRequestSpotInstancesResult();
                    my $spotInstanceRequestList = $requestSpotInstancesResult->getSpotInstanceRequest();
