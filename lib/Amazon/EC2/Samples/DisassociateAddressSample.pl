...
use lib qw(../../../.);  
 ...
 #**********************************************************************/
 use Amazon::EC2::Model::DisassociateAddressRequest;
 # @TODO: set request. Action can be passed as Amazon::EC2::Model::DisassociateAddressRequest
 ...
 # invokeDisassociateAddress($service, $request);
    ...
    #
  sub invokeDisassociateAddress {
      my ($service, $request) = @_;  
      eval {
              my $response = $service->disassociateAddress($request);
              
                print ("Service Response\n");
                print ("=============================================================================\n");

                print("        DisassociateAddressResponse\n");
