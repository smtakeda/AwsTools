...
use lib qw(../../../.);  
 ...
 # sample for Create Placement Group Action
 #**********************************************************************/
 use Amazon::EC2::Model::CreatePlacementGroupRequest;
 # @TODO: set request. Action can be passed as Amazon::EC2::Model::CreatePlacementGroupRequest
 # object or hash of parameters
 # invokeCreatePlacementGroup($service, $request);

                                                        
    # 
    # Create Placement Group Action Sample
    #
  sub invokeCreatePlacementGroup {
      my ($service, $request) = @_;  
      eval {
              my $response = $service->createPlacementGroup($request);
              
                print ("Service Response\n");
                print ("=============================================================================\n");

                print("        CreatePlacementGroupResponse\n");
