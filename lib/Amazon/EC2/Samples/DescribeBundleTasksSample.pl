...
use lib qw(../../../.);  
 ...
 #**********************************************************************/
 use Amazon::EC2::Model::DescribeBundleTasksRequest;
 # @TODO: set request. Action can be passed as Amazon::EC2::Model::DescribeBundleTasksRequest
 ...
 # invokeDescribeBundleTasks($service, $request);
    ...
    #
  sub invokeDescribeBundleTasks {
      my ($service, $request) = @_;  
      eval {
              my $response = $service->describeBundleTasks($request);
              
                print ("Service Response\n");
                print ("=============================================================================\n");

                print("        DescribeBundleTasksResponse\n");
                ...
                if ($response->isSetDescribeBundleTasksResult()) { 
                    print("            DescribeBundleTasksResult\n");
                    my $describeBundleTasksResult = $response->getDescribeBundleTasksResult();
                    my $bundleTaskList = $describeBundleTasksResult->getBundleTask();
