...
use lib qw(../../../.);  
 ...
 # sample for Delete Dhcp Options Action
 #**********************************************************************/
 use Amazon::EC2::Model::DeleteDhcpOptionsRequest;
 # @TODO: set request. Action can be passed as Amazon::EC2::Model::DeleteDhcpOptionsRequest
 # object or hash of parameters
 # invokeDeleteDhcpOptions($service, $request);

                                                                                                                                                                                                                                                                                            
    # 
    # Delete Dhcp Options Action Sample
    #
  sub invokeDeleteDhcpOptions {
      my ($service, $request) = @_;  
      eval {
              my $response = $service->deleteDhcpOptions($request);
              
                print ("Service Response\n");
                print ("=============================================================================\n");

                print("        DeleteDhcpOptionsResponse\n");
