...
#
# Delete Spot Datafeed Subscription  Sample
#
...
use lib qw(../../../.);  
 ...
 # sample for Delete Spot Datafeed Subscription Action
 #**********************************************************************/
 use Amazon::EC2::Model::DeleteSpotDatafeedSubscriptionRequest;
 # @TODO: set request. Action can be passed as Amazon::EC2::Model::DeleteSpotDatafeedSubscriptionRequest
 # object or hash of parameters
 # invokeDeleteSpotDatafeedSubscription($service, $request);

                                                                                                                                                                                                                                                                                                                                                                                
    # 
    # Delete Spot Datafeed Subscription Action Sample
    #
  sub invokeDeleteSpotDatafeedSubscription {
      my ($service, $request) = @_;  
      eval {
              my $response = $service->deleteSpotDatafeedSubscription($request);
              
                print ("Service Response\n");
                print ("=============================================================================\n");

                print("        DeleteSpotDatafeedSubscriptionResponse\n");
