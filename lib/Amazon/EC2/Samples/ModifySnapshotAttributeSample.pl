...
#
# Modify Snapshot Attribute  Sample
#
...
use lib qw(../../../.);  
 ...
 # sample for Modify Snapshot Attribute Action
 #**********************************************************************/
 use Amazon::EC2::Model::ModifySnapshotAttributeRequest;
 # @TODO: set request. Action can be passed as Amazon::EC2::Model::ModifySnapshotAttributeRequest
 # object or hash of parameters
 # invokeModifySnapshotAttribute($service, $request);

                                                                                                                                                                                            
    # 
    # Modify Snapshot Attribute Action Sample
    #
  sub invokeModifySnapshotAttribute {
      my ($service, $request) = @_;  
      eval {
              my $response = $service->modifySnapshotAttribute($request);
              
                print ("Service Response\n");
                print ("=============================================================================\n");

                print("        ModifySnapshotAttributeResponse\n");
