...
#
# Reset Snapshot Attribute  Sample
#
...
use lib qw(../../../.);  
 ...
 # sample for Reset Snapshot Attribute Action
 #**********************************************************************/
 use Amazon::EC2::Model::ResetSnapshotAttributeRequest;
 # @TODO: set request. Action can be passed as Amazon::EC2::Model::ResetSnapshotAttributeRequest
 # object or hash of parameters
 # invokeResetSnapshotAttribute($service, $request);

                                                                                                                                                                                                                    
    # 
    # Reset Snapshot Attribute Action Sample
    #
  sub invokeResetSnapshotAttribute {
      my ($service, $request) = @_;  
      eval {
              my $response = $service->resetSnapshotAttribute($request);
              
                print ("Service Response\n");
                print ("=============================================================================\n");

                print("        ResetSnapshotAttributeResponse\n");
