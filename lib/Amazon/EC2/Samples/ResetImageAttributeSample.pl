...
use lib qw(../../../.);  
 ...
 #**********************************************************************/
 use Amazon::EC2::Model::ResetImageAttributeRequest;
 # @TODO: set request. Action can be passed as Amazon::EC2::Model::ResetImageAttributeRequest
 ...
 # invokeResetImageAttribute($service, $request);
    ...
    #
  sub invokeResetImageAttribute {
      my ($service, $request) = @_;  
      eval {
              my $response = $service->resetImageAttribute($request);
              
                print ("Service Response\n");
                print ("=============================================================================\n");

                print("        ResetImageAttributeResponse\n");
