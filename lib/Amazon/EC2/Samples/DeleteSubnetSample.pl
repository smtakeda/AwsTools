...
use lib qw(../../../.);  
 ...
 # sample for Delete Subnet Action
 #**********************************************************************/
 use Amazon::EC2::Model::DeleteSubnetRequest;
 # @TODO: set request. Action can be passed as Amazon::EC2::Model::DeleteSubnetRequest
 # object or hash of parameters
 # invokeDeleteSubnet($service, $request);

                                                                                                                                                                                                                                                                                                
    # 
    # Delete Subnet Action Sample
    #
  sub invokeDeleteSubnet {
      my ($service, $request) = @_;  
      eval {
              my $response = $service->deleteSubnet($request);
              
                print ("Service Response\n");
                print ("=============================================================================\n");

                print("        DeleteSubnetResponse\n");
