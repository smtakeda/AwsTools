...
use lib qw(../../../.);  
 ...
 # @TODO: set request. Action can be passed as Amazon::EC2::Model::DeleteKeyPairRequest
 ...
 # invokeDeleteKeyPair($service, $request);
    ...
    #
  sub invokeDeleteKeyPair {
      my ($service, $request) = @_;  
      eval {
              my $response = $service->deleteKeyPair($request);
              
                print ("Service Response\n");
                print ("=============================================================================\n");

                print("        DeleteKeyPairResponse\n");
