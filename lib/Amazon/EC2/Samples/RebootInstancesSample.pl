...
use lib qw(../../../.);  
 ...
 #**********************************************************************/
 use Amazon::EC2::Model::RebootInstancesRequest;
 # @TODO: set request. Action can be passed as Amazon::EC2::Model::RebootInstancesRequest
 ...
 # invokeRebootInstances($service, $request);
    ...
    #
  sub invokeRebootInstances {
      my ($service, $request) = @_;  
      eval {
              my $response = $service->rebootInstances($request);
              
                print ("Service Response\n");
                print ("=============================================================================\n");

                print("        RebootInstancesResponse\n");
