...
#
# Delete Customer Gateway  Sample
#
...
use lib qw(../../../.);  
 ...
 # sample for Delete Customer Gateway Action
 #**********************************************************************/
 use Amazon::EC2::Model::DeleteCustomerGatewayRequest;
 # @TODO: set request. Action can be passed as Amazon::EC2::Model::DeleteCustomerGatewayRequest
 # object or hash of parameters
 # invokeDeleteCustomerGateway($service, $request);

                                                                                                                                                                                                                                                                                    
    # 
    # Delete Customer Gateway Action Sample
    #
  sub invokeDeleteCustomerGateway {
      my ($service, $request) = @_;  
      eval {
              my $response = $service->deleteCustomerGateway($request);
              
                print ("Service Response\n");
                print ("=============================================================================\n");

                print("        DeleteCustomerGatewayResponse\n");
