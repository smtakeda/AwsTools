...
use lib qw(../../../.);  
 ...
 # sample for Associate Dhcp Options Action
 #**********************************************************************/
 use Amazon::EC2::Model::AssociateDhcpOptionsRequest;
 # @TODO: set request. Action can be passed as Amazon::EC2::Model::AssociateDhcpOptionsRequest
 # object or hash of parameters
 # invokeAssociateDhcpOptions($service, $request);

                                                                                                                                                                                                                                                                                                                    
    # 
    # Associate Dhcp Options Action Sample
    #
  sub invokeAssociateDhcpOptions {
      my ($service, $request) = @_;  
      eval {
              my $response = $service->associateDhcpOptions($request);
              
                print ("Service Response\n");
                print ("=============================================================================\n");

                print("        AssociateDhcpOptionsResponse\n");
