...
use lib qw(../../../.);  
 ...
 #**********************************************************************/
 use Amazon::EC2::Model::AssociateAddressRequest;
 # @TODO: set request. Action can be passed as Amazon::EC2::Model::AssociateAddressRequest
  ...
  sub invokeAssociateAddress {
      ...
      eval {
              my $response = $service->associateAddress($request);
                ...
                print("        AssociateAddressResponse\n");
