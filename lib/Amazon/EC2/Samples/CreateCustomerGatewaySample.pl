...
use lib qw(../../../.);  
 ...
 #**********************************************************************/
 use Amazon::EC2::Model::CreateCustomerGatewayRequest;
 # @TODO: set request. Action can be passed as Amazon::EC2::Model::CreateCustomerGatewayRequest
 ...
 # invokeCreateCustomerGateway($service, $request);
    ...
    #
  sub invokeCreateCustomerGateway {
      my ($service, $request) = @_;  
      eval {
              my $response = $service->createCustomerGateway($request);
              
                print ("Service Response\n");
                print ("=============================================================================\n");

                print("        CreateCustomerGatewayResponse\n");
                ...
                if ($response->isSetCreateCustomerGatewayResult()) { 
                    print("            CreateCustomerGatewayResult\n");
                    my $createCustomerGatewayResult = $response->getCreateCustomerGatewayResult();
                    if ($createCustomerGatewayResult->isSetCustomerGateway()) { 
                        print("                CustomerGateway\n");
                        my $customerGateway = $createCustomerGatewayResult->getCustomerGateway();
