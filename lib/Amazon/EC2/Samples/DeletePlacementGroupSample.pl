...
use lib qw(../../../.);  
 ...
 # sample for Delete Placement Group Action
 #**********************************************************************/
 use Amazon::EC2::Model::DeletePlacementGroupRequest;
 # @TODO: set request. Action can be passed as Amazon::EC2::Model::DeletePlacementGroupRequest
 # object or hash of parameters
 # invokeDeletePlacementGroup($service, $request);

                                                                                        
    # 
    # Delete Placement Group Action Sample
    #
  sub invokeDeletePlacementGroup {
      my ($service, $request) = @_;  
      eval {
              my $response = $service->deletePlacementGroup($request);
              
                print ("Service Response\n");
                print ("=============================================================================\n");

                print("        DeletePlacementGroupResponse\n");
